...
public class ByteDataBufferView extends DataBufferView<Byte, ByteDataBuffer> implements ByteDataBuffer {
    ...
    @Override public ByteDataBuffer putByte(long index, byte value) {
